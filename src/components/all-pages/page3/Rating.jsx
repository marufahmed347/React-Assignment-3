...
export default function OverallRating() {
  return (
    <div className="max-w-6xl w-full mx-auto p-4 md:p-6 rounded-md">
      ...
      <div className="flex flex-col md:flex-row gap-5 md:items-start">
        ...
        <div className="md:w-[300px]">
          <div className="flex items-center my-auto gap-5 mb-5">
            ...
            <div className="">
            <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-[#232323]">Overall rating</h2>
            <p className="text-lg text-[#838383]">{totalReviews} Reviews</p>
            </div>
          </div>
        ...
        <div className="md:w-[549px] w-full space-y-2">
          {ratings.map((item, index) => (
            <div key={index} className="flex items-center gap-3">
              <div className="w-14 text-sm text-[#484848]">{item.label}</div>
              <div className="flex-1 bg-[#D9D9D9] h-2 rounded">
                <div
                  className="bg-[#1677BD] h-full rounded"
